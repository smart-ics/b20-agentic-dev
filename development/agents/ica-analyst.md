...
- DOMAIN artifact work -> `ics-domain-creation`
- FEATURE artifact work -> `ics-feature-creation`
...
- FEATURE change -> request ARCHITECTURE review from the ica-architect. You do
