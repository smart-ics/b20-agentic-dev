---
name: ics-feasibility-assessment
...
The target state belongs to ARCHITECTURE (when Architecture Applicability is ARCHITECTURE-REQUIRED).
...
The Architect owns the Architecture Applicability decision, determining if a formal ARCHITECTURE artifact is required.
...
ARCHITECTURE-REQUIRED applies when the change requires formal technical target-state definition, including:
* new or changed components
* new integration boundaries
* persistence/data ownership changes
* significant technical decisions
* architectural constraints
* cross-cutting technical changes
* meaningful structural changes
* unresolved technical realization ambiguity

ARCHITECTURE-NOT-REQUIRED applies when the existing technical structure and approved feasibility decisions are sufficient to implement the change safely without introducing or changing architectural knowledge.
