---
name: ics-architecture-creation
...
## What I do
- Create a new ARCHITECTURE artifact (if Architecture Applicability is ARCHITECTURE-REQUIRED)
...
If ARCHITECTURE is not required, this skill is bypassed.
